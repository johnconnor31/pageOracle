...
export default function HomePage() {
  ...
  const popoverSx = popoverPosition ? {
    position: 'fixed', top: popoverPosition.top, left: popoverPosition.left, width: popoverPosition.width, height: popoverPosition.height,
    maxWidth: 'calc(100vw - 32px)', maxHeight: 'calc(100vh - 32px)', overflowY: 'auto', zIndex: 1000,
