        ...
        <Box component="main" id="top" className="hero-section">
          ...
          {page ? (
            <Box className="browser-workspace" aria-label="Fetched page text">
              ...
              <Box className="extracted-page"><Typography className="preview-kicker">FETCHED PAGE · {page.wordCount.toLocaleString()} WORDS</Typography><Typography component="h2">{page.title}</Typography><Typography className="extracted-text">{page.text}</Typography></Box>
